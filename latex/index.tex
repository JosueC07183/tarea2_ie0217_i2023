...
\hypertarget{index_autotoc_md1}{}\doxysubsubsection{Escuela de Ingeniería Eléctrica}\label{index_autotoc_md1}
\hypertarget{index_autotoc_md2}{}\doxysubsubsection{Faculta de Ingeniería}\label{index_autotoc_md2}
\hypertarget{index_autotoc_md3}{}\doxysubsubsection{IE0217-\/\+Estructuras de Abstractas de Datos y Algoritmos}\label{index_autotoc_md3}
\hypertarget{index_autotoc_md4}{}\doxyparagraph{Profesor\+: Esteban Badilla}\label{index_autotoc_md4}
\hypertarget{index_autotoc_md5}{}\doxyparagraph{Estudiante\+: Josué Salmerón Córdoba}\label{index_autotoc_md5}
\hypertarget{index_autotoc_md6}{}\doxyparagraph{I ciclo 2023}\label{index_autotoc_md6}
\hypertarget{index_autotoc_md7}{}\doxysubsubsection{Tarea 2}\label{index_autotoc_md7}
\hypertarget{index_autotoc_md8}{}\doxysection{Resumen}\label{index_autotoc_md8}
\begin{quote}
...
\hypertarget{index_autotoc_md9}{}\doxysection{Análisis de la notación Big O en cada algoritmo de ordenamiento.}\label{index_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md10}{}\doxysection{Comandos para correr la tarea}\label{index_autotoc_md10}

\begin{DoxyItemize}
\item Basta con abrir un terminal dentro de la carpeta {\ttfamily tarea\+Dos}y escribir el siguiente comando\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{make run}

\end{DoxyCode}

\end{DoxyItemize}\hypertarget{index_autotoc_md11}{}\doxysection{Referencias.}\label{index_autotoc_md11}
\begin{quote}
